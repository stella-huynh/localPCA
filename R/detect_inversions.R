...
#' @param bcftools By default, bcftools software should be installed in /usr/bin. If this is not the case, use this option to specify the user-defined full path to bcftools
#' @param bgzip By default, bgzip software should be installed in /usr/bin. If this is not the case, use this option to specify the user-defined full path to bgzip Required if keep_tmp=TRUE
